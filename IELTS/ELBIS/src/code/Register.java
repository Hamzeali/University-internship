...
public class Register extends JFrame {
	...
	public Register() throws SQLException {
		...
		scrollPane.setBounds(149, 249, 130, 84);
		...
		registerBtn.addActionListener(l -> {
			...
			if (passwordField.getText().equals(confirmPasswordField.getText())) {
				...
				try {
					...
					sqlConnection.sqlAddUser(firstnameField.getText(), lastnameField.getText(), usernameField.getText(),
							passwordField.getText(), emailField.getText(), selectedSectionList,
